(function () {
  ...
  var logoSvg =
    ...
    '<path d="M11 27 V7" stroke="#5d7d68" stroke-width="1.4" stroke-linecap="round"/>' +
    '<path d="M11 15 C6.5 14.5 4 11.5 4 7.5 C8.5 8 11 11 11 15 Z" stroke="#87a08f" stroke-width="1.1" fill="none"/>' +
    '<path d="M11 11 C15.5 10.5 18 7.5 18 3.5 C13.5 4 11 7 11 11 Z" stroke="#7b6aad" stroke-width="1.1" fill="none"/>' +
    "</svg>";
